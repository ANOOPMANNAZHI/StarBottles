          ...
          >
            <div className="max-w-7xl mx-auto px-6 py-5 space-y-1 max-h-[calc(100svh-70px)] overflow-y-auto">
              ...
              <a
                ...
                rel="noopener noreferrer"
                onClick={() => setMenuOpen(false)}
                className="flex items-center gap-3 px-4 py-3 font-inter text-sm font-medium text-gray-700 hover:text-brand-dark hover:bg-brand-pale/40 rounded-xl transition-all duration-200"
              >
